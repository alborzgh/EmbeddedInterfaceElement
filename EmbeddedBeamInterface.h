...
#ifndef EmbedBeamInterface_h
#define EmbedBeamInterface_h
...
#define EBI_NUM_NODE 10
// number of dimensions
#define EBI_NUM_DIM  3
// degrees of freedom per element
#define EBI_NUM_DOF  36
...
class EmbeddedBeamInterface : public Element
{
  public:
	...
	EmbeddedBeamInterface(int tag, int beamTag, int solidTag, int crdTransfTag, double beamRho, double beamTheta, double solidXi, double solidEta, double solidZeta, double radius, double area);
    EmbeddedBeamInterface();
    ~EmbeddedBeamInterface();

    const char *getClassType(void) const {return "EmbeddedBeamInterface";};
