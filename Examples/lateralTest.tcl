...
for {set ii 0} {$ii < $b_numEle} {incr ii}	{
	...
	set interfaceElems [concat $interfaceElems [generateInterfacePoints $elem 1  -embed -shape circle -nP $nP -nL $nL -radius $radius -file $interfaceElemsFile ]]
}
