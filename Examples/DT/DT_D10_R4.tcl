...
set interfaceElems [generateInterfacePoints 100009 1 -shape circle -nP 4 -nL 4 -radius $radius ]
set interfaceElems [generateInterfacePoints 100010 1 -shape circle -nP 4 -nL 4 -radius $radius ]
...
eval "recorder Element -time -file contactBeam_D10_R4.out -ele $interfaceElems locBeam"
eval "recorder Element -time -file contactSolid_D10_R4.out -ele $interfaceElems locSolid"
eval "recorder Element -time -file contactBeamCL_D10_R4.out -ele $interfaceElems beamCL"
eval "recorder Element -time -file c1_D10_R4.out -ele $interfaceElems c1"
eval "recorder Element -time -file c2_D10_R4.out -ele $interfaceElems c2"
eval "recorder Element -time -file c3_D10_R4.out -ele $interfaceElems c3"
recorder Node    -time -file beamDisp_D10_R4.out -node 100001 100002 100003 100004 100005 100006 100007 100008 100009 100010 100011 -dof 1 2 3 4 5 6  disp
recorder Node    -time -file displacement_D10_R4.out -nodeRange 1 [expr ($numEle_y+1)*($numEle_z+1)*($numEle_z+1)]  -dof 1 2 3 disp
