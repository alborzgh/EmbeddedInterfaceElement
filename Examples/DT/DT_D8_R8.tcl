...
eval "recorder Element -time -file contactBeam_D8_R8.out -ele $interfaceElems locBeam"
eval "recorder Element -time -file contactSolid_D8_R8.out -ele $interfaceElems locSolid"
eval "recorder Element -time -file contactBeamCL_D8_R8.out -ele $interfaceElems beamCL"
eval "recorder Element -time -file c1_D8_R8.out -ele $interfaceElems c1"
eval "recorder Element -time -file c2_D8_R8.out -ele $interfaceElems c2"
eval "recorder Element -time -file c3_D8_R8.out -ele $interfaceElems c3"
recorder Node    -time -file beamDisp_D8_R8.out -node 100001 100002 100003 100004 100005 100006 100007 100008 100009 -dof 1 2 3 4 5 6  disp
recorder Node    -time -file displacement_D8_R8.out -nodeRange 1 [expr ($numEle_y+1)*($numEle_z+1)*($numEle_z+1)]  -dof 1 2 3 disp
