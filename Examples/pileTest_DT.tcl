...
node 100004 0 0 8.0
node 100005 0 0 9.0
node 100006 0 0 10.0
node 100007 0 0 11.0
node 100008 0 0 12.0
node 100009 0 0 13.0
node 100010 0 0 14.0
node 100011 0 0 15.0
...
set interfaceElems [generateInterfacePoints 100001 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100002 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100003 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100004 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100005 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100006 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100007 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100008 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100009 1 -shape circle -nP 10 -nL 10 -radius $radius ]
set interfaceElems [generateInterfacePoints 100010 1 -shape circle -nP 10 -nL 10 -radius $radius ]
...
recorder Node    -time -file beamDisp.out -node 100001 100002 100003 100004 100005 100006 100007 100008 100009 100010 100011 -dof 1 2 3 4 5 6  disp
