...
#ifndef EmbedBeamToeP_h
#define EmbedBeamToeP_h
...
class EmbeddedBeamToeP : public Element
{
public:
    EmbeddedBeamToeP(int tag);
    EmbeddedBeamToeP(int tag, int beamTag, std::vector <int> solidTag, int crdTransfTag, 
    ...
    const char *getClassType(void) const { return "EmbeddedBeamToeP"; };
