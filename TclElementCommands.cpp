...
extern void *OPS_Quad4FiberOverlay(void);     // Alborz Ghofrani
extern void *OPS_Brick8FiberOverlay(void);    // Alborz Ghofrani
extern void *OPS_QuadBeamEmbedContact(void);  // Alborz Ghofrani
extern void *OPS_EmbeddedBeamInterface(void); // Alborz Ghofrani
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  } else if ((strcmp(argv[1],"Quad4FiberOverlay") == 0)) { 	//////////////////////// Alborz Ghofrani
  ...
  } else if ((strcmp(argv[1],"Brick8FiberOverlay") == 0)) { //////////////////////// Alborz Ghofrani
  ...
  else if ((strcmp(argv[1], "QuadBeamEmbedContact") == 0)) { 	//////////////////////// Alborz Ghofrani
  ...
  else if ((strcmp(argv[1], "EmbeddedBeamInterface") == 0)) { 	//////////////////////// Alborz Ghofrani
